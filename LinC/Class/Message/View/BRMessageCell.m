...
#import "BRBubbleView+Text.h"
#import "BRBubbleView+Image.h"
#import "BRBubbleView+Location.h"
#import "BRBubbleView+Voice.h"
#import "BRBubbleView+Video.h"
#import "BRBubbleView+File.h"
#import "BREmotionEscape.h"

CGFloat const BRMessageCellPadding = 10;

NSString *const BRMessageCellIdentifierRecvText = @"BRMessageCellRecvText";
NSString *const BRMessageCellIdentifierRecvLocation = @"BRMessageCellRecvLocation";
NSString *const BRMessageCellIdentifierRecvVoice = @"BRMessageCellRecvVoice";
NSString *const BRMessageCellIdentifierRecvVideo = @"BRMessageCellRecvVideo";
NSString *const BRMessageCellIdentifierRecvImage = @"BRMessageCellRecvImage";
NSString *const BRMessageCellIdentifierRecvFile = @"BRMessageCellRecvFile";

NSString *const BRMessageCellIdentifierSendText = @"BRMessageCellSendText";
NSString *const BRMessageCellIdentifierSendLocation = @"BRMessageCellSendLocation";
NSString *const BRMessageCellIdentifierSendVoice = @"BRMessageCellSendVoice";
NSString *const BRMessageCellIdentifierSendVideo = @"BRMessageCellSendVideo";
NSString *const BRMessageCellIdentifierSendImage = @"BRMessageCellSendImage";
NSString *const BRMessageCellIdentifierSendFile = @"BRMessageCellSendFile";

@interface BRMessageCell ()
{
...
+ (void)initialize
{
    ...
    BRMessageCell *cell = [self appearance];
    cell.statusSize = 20;
                         ...
                         model:(id<IMessageModel>)model
{
    ...
    _bubbleView = [[BRBubbleView alloc] initWithMargin:isSender?_rightBubbleMargin:_leftBubbleMargin isSender:isSender];
...
{
    //bubble view
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeBottom multiplier:1.0 constant:-BRMessageCellPadding]];
...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    if ([self respondsToSelector:@selector(isCustomBubbleView:)] && [self isCustomBubbleView:model]) {
        ...
        switch (model.bodyType) {
            case EMMessageBodyTypeText:
            {
                _bubbleView.textLabel.attributedText = [[BREmotionEscape sharedInstance] attStringFromTextForChatting:model.text textFont:self.messageTextFont];
            }
                break;
            case EMMessageBodyTypeImage:
            {
...
+ (NSString *)cellIdentifierWithModel:(id<IMessageModel>)model
{
    ...
    if (model.isSender) {
        switch (model.bodyType) {
            case EMMessageBodyTypeText:
                cellIdentifier = BRMessageCellIdentifierSendText;
                break;
            case EMMessageBodyTypeImage:
                cellIdentifier = BRMessageCellIdentifierSendImage;
                break;
            case EMMessageBodyTypeVideo:
                cellIdentifier = BRMessageCellIdentifierSendVideo;
                break;
            case EMMessageBodyTypeLocation:
                cellIdentifier = BRMessageCellIdentifierSendLocation;
                break;
            case EMMessageBodyTypeVoice:
                cellIdentifier = BRMessageCellIdentifierSendVoice;
                break;
            case EMMessageBodyTypeFile:
                cellIdentifier = BRMessageCellIdentifierSendFile;
                break;
            default:
                break;
        }
        ...
        switch (model.bodyType) {
            case EMMessageBodyTypeText:
                cellIdentifier = BRMessageCellIdentifierRecvText;
                break;
            case EMMessageBodyTypeImage:
                cellIdentifier = BRMessageCellIdentifierRecvImage;
                break;
            case EMMessageBodyTypeVideo:
                cellIdentifier = BRMessageCellIdentifierRecvVideo;
                break;
            case EMMessageBodyTypeLocation:
                cellIdentifier = BRMessageCellIdentifierRecvLocation;
                break;
            case EMMessageBodyTypeVoice:
                cellIdentifier = BRMessageCellIdentifierRecvVoice;
                break;
            case EMMessageBodyTypeFile:
                cellIdentifier = BRMessageCellIdentifierRecvFile;
                break;
            default:
                break;
        }
...
+ (CGFloat)cellHeightWithModel:(id<IMessageModel>)model
{
    ...
    CGFloat height = BRMessageCellPadding + cell.bubbleMargin.top + cell.bubbleMargin.bottom;
    
    switch (model.bodyType) {
        case EMMessageBodyTypeText:
        {
            NSAttributedString *text = [[BREmotionEscape sharedInstance] attStringFromTextForChatting:model.text textFont:cell.messageTextFont];
