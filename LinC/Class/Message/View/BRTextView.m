...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [BRTextView maxCharactersPerLine];
...
{
    return [BRTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [BRTextView maxCharactersPerLine]) + 1;
}
