...
static BRSDKHelper *helper = nil;

@implementation BRSDKHelper
...
{
    NSString *willSendText = [BRConvertToCommonEmoticonsHelper convertToCommonEmoticons:text];
