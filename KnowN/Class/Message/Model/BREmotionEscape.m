...
@implementation BRTextAttachment
...
@implementation BREmotionEscape

static BREmotionEscape *_sharedInstance = nil;
...
+ (BREmotionEscape *)sharedInstance
{
    ...
    {
        @synchronized(self) {
            _sharedInstance = [[BREmotionEscape alloc] init];
        }
    }
...
- (NSMutableAttributedString *) attributtedStringFromText:(NSString *) aInputText
{
    ...
    for (NSTextCheckingResult *match in [matches reverseObjectEnumerator]) {
        ...
        BRTextAttachment * textAttachment = [[BRTextAttachment alloc ] initWithData:nil ofType:nil];
